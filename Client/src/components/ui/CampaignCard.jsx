 ...
 * @param {number} props.levelCount
 * @param {number} props.completionPercent - 0-100
 * @param {boolean} props.completed - finished a full run at least once
 * @param {string} props.author
 * @param {Function} props.onClick
 * @param {Function} [props.onEdit] - shown as Edit button when provided
 * @param {Function} [props.onDelete] - shown as Delete button when provided
 */
