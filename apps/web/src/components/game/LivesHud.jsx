 ...
 *
 * @param {Object} props
 * @param {number} props.lives - remaining lives
 * @param {number} props.levelIndex - 1-based current level number
 * @param {number} props.totalLevels
 * @param {boolean} props.flash - briefly emphasise after gaining a life
 */
export const LivesHud = ({ lives, levelIndex, totalLevels, flash = false }) => {
